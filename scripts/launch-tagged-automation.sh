...
APP="$HOME/Library/Developer/Xcode/DerivedData/gmux-${TAG_SLUG}/Build/Products/Debug/Gmux DEV ${TAG}.app"
BID="com.gmuxterm.app.debug.${TAG_ID}"
SOCK="/tmp/gmux-debug-${TAG_SLUG}.sock"
DSOCK="$HOME/Library/Application Support/gmux/cmuxd-dev-${TAG_SLUG}.sock"
LOG="/tmp/gmux-debug-${TAG_SLUG}.log"
...
sleep 0.5
pkill -f "Gmux DEV ${TAG}.app/Contents/MacOS/Gmux DEV" || true
rm -f "$SOCK" "$DSOCK"
sleep 0.5
