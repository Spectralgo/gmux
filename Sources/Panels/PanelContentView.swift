...
struct PanelContentView: View {
    ...
    var body: some View {
        ...
        case .agentProfile:
            if let agentProfilePanel = panel as? AgentProfilePanel {
                AgentProfilePanelView(
                    panel: agentProfilePanel,
                    isFocused: isFocused,
                    isVisibleInUI: isVisibleInUI,
                    portalPriority: portalPriority,
                    onRequestPanelFocus: onRequestPanelFocus
        ...
        case .mailPanel:
            if let mailPanel = panel as? MailPanel {
                MailPanelView(
                    panel: mailPanel,
                    isFocused: isFocused,
                    isVisibleInUI: isVisibleInUI,
        ...
        case .refinery:
            if let refineryPanel = panel as? RefineryPanel {
                RefineryPanelView(
                    panel: refineryPanel,
                    isFocused: isFocused,
                    isVisibleInUI: isVisibleInUI,
