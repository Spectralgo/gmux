...
extension UNUserNotificationCenter {
    private static let removalQueue = DispatchQueue(
        label: "com.gmuxterm.notification-removal",
        qos: .utility
    )
...
enum NotificationSoundSettings {
    ...
    private static let stagedCustomSoundBaseName = "gmux-custom-notification-sound"
    private static let customSoundPreparationQueue = DispatchQueue(
        label: "com.gmuxterm.notification-sound-preparation",
        qos: .utility
    )
    ...
    private static let customCommandQueue = DispatchQueue(
        label: "com.gmuxterm.notification-custom-command",
        qos: .utility
    )
...
final class TerminalNotificationStore: ObservableObject {
    ...
    static let categoryIdentifier = "com.gmuxterm.app.userNotification"
    static let actionShowIdentifier = "com.gmuxterm.app.userNotification.show"
